			...
			this.template ='<div class="m-winwrapper">\
							    <div class="winwrapper">\
							        <div class="m-win m-win-simple">\
							            ...
							            <div class="winft">\
							                <button type="button" class="u-btn u-btn-primary u-btn-fw" base.dataStructure.data-action="confirm">{confirmText}</button>\
							                <button type="button" class="u-btn u-btn-normal u-btn-fw" base.dataStructure.data-action="cancel">取消</button>\
							            </div>\
							        </div>\
							    </div>\
							</div>';
